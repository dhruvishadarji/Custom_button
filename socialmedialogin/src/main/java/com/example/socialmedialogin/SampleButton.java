...
public class SampleButton extends FacebookButtonBase {
    // ***
    ...
    public enum ToolTipMode {
        ...
        public static SampleButton.ToolTipMode DEFAULT = AUTOMATIC;

        public static SampleButton.ToolTipMode fromInt(int enumValue) {
            for (SampleButton.ToolTipMode mode : values()) {
    ...
    private static final String TAG = SampleButton.class.getName();
    private boolean confirmLogout;
    private String loginText;
    private String logoutText;
    private SampleButton.LoginButtonProperties properties = new SampleButton.LoginButtonProperties();
    ...
    private SampleButton.ToolTipMode toolTipMode;
    ...
    /**
     * Create the SampleButton by inflating from XML
     *
    ...
    /**
     * Create the SampleButton by inflating from XML and applying a style.
     *
     ...
     * attempt by the user will fail. The SampleButton can only be associated with either
     * read permissions or publish permissions, but not both. Calling both
     * setReadPermissions and setPublishPermissions on the same instance of SampleButton
     ...
     * manage the setting of permissions outside of the SampleButton class altogether
     ...
     * attempt by the user may fail. The SampleButton can only be associated with either
     * read permissions or publish permissions, but not both. Calling both
     * setReadPermissions and setPublishPermissions on the same instance of SampleButton
     * will result in an exception being thrown unless clearPermissions is called in between.
     * <p/>
    ...
    /**
     * Clears the permissions currently associated with this SampleButton.
     */
    public void clearPermissions() {
     ...
     */
    public void setToolTipMode(SampleButton.ToolTipMode toolTipMode) {
        this.toolTipMode = toolTipMode;
    }

    /**
     * Return the current {@link SampleButton.ToolTipMode} for this SampleButton
     *
     * @return The {@link SampleButton.ToolTipMode}
     */
    public SampleButton.ToolTipMode getToolTipMode() {
        return toolTipMode;
    }
        ...
        switch (toolTipMode) {
            ...
            case DISPLAY_ALWAYS:
                String toolTipString = getResources().getString(
                        com.facebook.login.R.string.com_facebook_tooltip_default);
                displayToolTip(toolTipString);
                break;
            case NEVER_DISPLAY:
                break;
    ...
    void setProperties(SampleButton.LoginButtonProperties properties) {
    ...
    protected void configureButton(
        ...
        setCompoundDrawablesWithIntrinsicBounds(
                AppCompatResources.getDrawable(getContext(), com.facebook.login.R.drawable.com_facebook_button_login_logo),
                null,
                null,
                null);
    }

    protected SampleButton.LoginClickListener getNewLoginClickListener() {
        return new SampleButton.LoginClickListener();
    }
    ...
    private void parseLoginButtonAttributes(
            ...
            final int defStyleAttr,
            final int defStyleRes) {
        this.toolTipMode = SampleButton.ToolTipMode.DEFAULT;
        final TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                com.facebook.login.R.styleable.com_facebook_login_view,
                defStyleAttr,
                defStyleRes);
        try {
            confirmLogout = a.getBoolean(com.facebook.login.R.styleable.com_facebook_login_view_com_facebook_confirm_logout, true);
            loginText = a.getString(com.facebook.login.R.styleable.com_facebook_login_view_com_facebook_login_text);
            logoutText = a.getString(com.facebook.login.R.styleable.com_facebook_login_view_com_facebook_logout_text);
            toolTipMode = SampleButton.ToolTipMode.fromInt(a.getInt(
                    com.facebook.login.R.styleable.com_facebook_login_view_com_facebook_tooltip_mode,
                    SampleButton.ToolTipMode.DEFAULT.getValue()));
        } finally {
            a.recycle();
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width;
        if (text == null) {
            text = resources.getString(com.facebook.login.R.string.com_facebook_loginview_log_in_button_continue);
            logInWidth = measureButtonWidth(text);
            width = resolveSize(logInWidth, widthMeasureSpec);
            if (width < logInWidth) {
                text = resources.getString(com.facebook.login.R.string.com_facebook_loginview_log_in_button);
            }
        }
        logInWidth = measureButtonWidth(text);
        ...
        text = logoutText;
        if (text == null) {
            text = resources.getString(com.facebook.login.R.string.com_facebook_loginview_log_out_button);
        }
    ...
    private void setButtonText() {
        ...
        if (!isInEditMode() && AccessToken.isCurrentAccessTokenActive()) {
            setText((logoutText != null) ?
                    logoutText :
                    resources.getString(com.facebook.login.R.string.com_facebook_loginview_log_out_button));
        } else {
            if (loginText != null) {
                setText(loginText);
            } else {
                String text = resources.getString(
                        com.facebook.login.R.string.com_facebook_loginview_log_in_button_continue);
                int width = getWidth();
    ...
    protected class LoginClickListener implements OnClickListener {
        ...
        protected void performLogin() {
            ...
            if (LoginAuthorizationType.PUBLISH.equals(properties.authorizationType)) {
                if (SampleButton.this.getFragment() != null) {
                    loginManager.logInWithPublishPermissions(
                            SampleButton.this.getFragment(),
                            properties.permissions);
                } else if (SampleButton.this.getNativeFragment() != null) {
                    loginManager.logInWithPublishPermissions(
                            SampleButton.this.getNativeFragment(),
                            properties.permissions);
                } else {
                    loginManager.logInWithPublishPermissions(
                            SampleButton.this.getActivity(),
                            properties.permissions);
                }
            } else {
                if (SampleButton.this.getFragment() != null) {
        ...
        protected void performLogout(Context context) {
            ...
            if (confirmLogout) {
                ...
                String logout = getResources().getString(
                        com.facebook.login.R.string.com_facebook_loginview_log_out_action);
                String cancel = getResources().getString(
                        com.facebook.login.R.string.com_facebook_loginview_cancel_action);
                String message;
                Profile profile = Profile.getCurrentProfile();
                if (profile != null && profile.getName() != null) {
                    message = String.format(
                            getResources().getString(
                                    com.facebook.login.R.string.com_facebook_loginview_logged_in_as),
                            profile.getName());
                } else {
                    message = getResources().getString(
                            com.facebook.login.R.string.com_facebook_loginview_logged_in_using_facebook);
                }
